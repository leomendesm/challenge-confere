...
it('should dispatch two times with success', () => {
    ...
    expect(dispatch).toHaveBeenCalledWith({"payload": "test", "type": "FETCHING_CONTENT_DATA_SUCCESS"});

    expect(dispatch).not.toHaveBeenCalledWith({"payload": "error", "type": "FETCHING_CONTENT_DATA_FAIL"});
})
...
it('should dispatch two times with fail', () => {
    ...
    expect(dispatch).toHaveBeenCalledWith({"payload": "err", "type": "FETCHING_CONTENT_DATA_FAIL"});

    expect(dispatch).not.toHaveBeenCalledWith({"payload": "error", "type": "FETCHING_CONTENT_DATA_SUCCESS"});
})